    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.navButtonsContainer}>
          ...
          {isLastSlide ? (
            <TouchableOpacity onPress={handleFinish} style={styles.startButtonLarge}>
...
const visualStyles = StyleSheet.create({
  ...
  coffeeBackground: { backgroundColor: "#3B82F6" },
  shirtBackground: { backgroundColor: "#10B981" },
  wineBackground: { backgroundColor: "#F56565" },
});
